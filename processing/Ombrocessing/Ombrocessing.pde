...
AnimationScanimation2 animScanimation2; 
AnimationScanimation3 animScanimation3; 
...
void setup()
{
  ...
  animScanimation2 = new AnimationScanimation2(scanimation);
  animScanimation2.setup();
  
  animScanimation3 = new AnimationScanimation3(scanimation);
  animScanimation3.setup();
